...
class resultClass:
    def __init__(self, root):
        ...
        title = Label(root, text="Add Student Results", font=("goudy old style", 20, "bold"), bg="orange", fg="#262626")
        ...
        #====button=====#
        self.btn_add = Button(self.root,text="Submit", font=("times new roman", 15), bg="lightgreen", activebackground="lightgreen",cursor="hand2",command=self.add)
        self.btn_add.place(x=300, y=420, width=120, height=35)   
        self.btn_Clear = Button(self.root,text="Clear", font=("goudy old style", 15), bg="lightgray", activebackground="lightgray",cursor="hand2",command=self.clear)
        self.btn_Clear.place(x=430, y=420, width=120, height=35)
        
        #========image========#
        self.bg_img=Image.open("result.jpg")
        self.bg_img=self.bg_img.resize((500,330))
