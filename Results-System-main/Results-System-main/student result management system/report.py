...
class reportClass:
    def __init__(self, root):
        ...
        title = Label(root, text="View Student Results", font=("goudy old style", 20, "bold"), bg="orange", fg="#262626")
        ...
        #===delete#
        btn_clear = Button(self.root,text="Delete", font=("goudy old style", 15, "bold"), bg="red", fg="white",cursor="hand2",command=self.delete)
        btn_clear.place(x=500, y=350, width=150, height=35)
